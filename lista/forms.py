...
class ListaForms(forms.ModelForm):
    ...
    descricao = forms.CharField(label='Descrição', widget=forms.Textarea(attrs={"class": "form-control", "placeholder": 
    "Deixe a tarefa mais específica. Ex: Deixar tudo organizado. Principalmente embaixo da cama!"}))
